  ...
  return (
    <header className="mb-2">
      <div className="relative flex max-w-screen-2xl flex-col overflow-hidden py-3 md:mx-auto md:flex-row md:items-center">
        <div className="w-max flex items-center whitespace-nowrap gap-1 text-2xl font-black z-10">
        ...
        <nav
          ...
          className="peer-checked:mt-8 peer-checked:max-h-56 flex max-h-0 w-full flex-col items-center justify-between overflow-hidden transition-all md:ml-    q24 md:max-h-full md:flex-row md:items-center"
        >
          <ul className="flex flex-col gap-4 text-xs font-medium items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
